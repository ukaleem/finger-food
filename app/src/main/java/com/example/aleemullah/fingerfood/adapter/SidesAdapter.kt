...
import com.example.aleemullah.fingerfood.userSection.SidesItems
import java.util.*
import kotlin.collections.ArrayList

class SidesAdapter(private var activity: SidesItems, private var items: ArrayList<SidesData>) :
    BaseAdapter() {
...
//    }
    ...
    private class ViewHolder(row: View?) {
        ...
        var quantity_edit_text: EditText? = null
        var done_Btn: Button

        init {
           this.item_text = row?.findViewById(R.id.item_Text)
           this.price_text = row?.findViewById(R.id.priceText)
           this.quantity_edit_text = row?.findViewById(R.id.quantityText)
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        viewHolder.quantity_edit_text?.setText(StartersData.quantity_edit_text)
